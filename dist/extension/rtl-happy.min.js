...
function (_Base) {
  ...
  function AppJira() {
    ...
    return _possibleConstructorReturn(this, (AppJira.__proto__ || Object.getPrototypeOf(AppJira)).call(this, app));
  }
  ...
  _createClass(Base, [{
    ...
    value: function rtl() {
      ...
      setInterval(function () {
        _this.prepareRTLHappy(_this.app.targetList);
      }, 1000);
    }
  }, {
    key: "injectResources",
    ...
    value: function updateStyle($target) {
      ...
      if ($target.is('iframe')) {
        ...
        setInterval(function () {
          _this3.prepareRTLHappy(_this3.app.targetList, (0, _jquery.default)($target.contents()));
        }, 1000);
      }
